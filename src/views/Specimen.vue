<template>
  <div class="page-content">
    <section class="is-paddingless mb-2">
      <router-link :to="{name: 'home'}" class="button is-transparent">‹ Back to all Work</router-link>
    </section>
    <article v-if="specimen">
      ...
      <p class="is-family-sans-serif is-size-5-fullhd specimen-page-content" v-html="specimen.description"></p>
