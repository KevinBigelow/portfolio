<template>
  <div class="specimen-page-content page-content">
    <article v-if="specimen">
      ...
      <p class="is-family-sans-serif p-content mb-1">The target audience was local businesses who had no website, an outdated website, and/or a weak web presence.</p>
